...
Given("I start the character creation wizard on mobile", async function () {
  ...
  await this.page.evaluate(() =>
    document
      .querySelector('[data-testid="wizard-start-button"]')
      ?.scrollIntoView(),
  );
  await this.clickElement('[data-testid="wizard-start-button"]');
});
...
When("I complete the basic information step", async function () {
  ...
  await this.clickElement(
    `[data-testid="race-option-${characterData.race.toLowerCase()}"]`,
  );
...
When("I complete the basic information step on mobile", async function () {
  ...
  await this.page.evaluate(() =>
    document
      .querySelector('[data-testid="character-name-input"]')
      ?.scrollIntoView(),
  );
  await this.fillField(
    '[data-testid="character-name-input"]',
  ...
  await this.page.evaluate(() =>
    document
      .querySelector('[data-testid="character-age-input"]')
      ?.scrollIntoView(),
  );
  await this.fillField(
    '[data-testid="character-age-input"]',
  ...
  await this.page.evaluate(() =>
    document.querySelector('[data-testid="gender-select"]')?.scrollIntoView(),
  );
  await this.clickElement('[data-testid="gender-select"]');
  await this.clickElement(
    `[data-testid="gender-option-${characterData.gender.toLowerCase()}"]`,
  ...
  await this.page.evaluate(() =>
    document.querySelector('[data-testid="race-select"]')?.scrollIntoView(),
  );
  await this.clickElement('[data-testid="race-select"]');
  await this.clickElement(
    `[data-testid="race-option-${characterData.race.toLowerCase()}"]`,
  ...
  await this.page.evaluate(() =>
    document
      .querySelector('[data-testid="background-textarea"]')
      ?.scrollIntoView(),
  );
  await this.fillField(
    '[data-testid="background-textarea"]',
  ...
  await this.page.evaluate(() =>
    document
      .querySelector('[data-testid="next-step-button"]')
      ?.scrollIntoView(),
  );
  await this.clickElement('[data-testid="next-step-button"]');
});
...
When("I roll characteristics", async function () {
  ...
  const rollPromise = this.waitForAPIResponse(
    "characters/roll-characteristics",
    "POST",
  );
...
When("I roll characteristics on mobile", async function () {
  ...
  await this.page.evaluate(() =>
    document
      .querySelector('[data-testid="roll-characteristics-button"]')
      ?.scrollIntoView(),
  );
...
When("I select a homeworld", async function () {
  ...
  const selectionPromise = this.waitForAPIResponse(
    "characters/select-homeworld",
    "POST",
  );
...
When("I select a homeworld on mobile", async function () {
  ...
  await this.page.evaluate(() =>
    document
      .querySelector('[data-testid="homeworld-option"]:first-of-type')
      ?.scrollIntoView(),
  );
  await this.clickElement('[data-testid="homeworld-option"]:first-of-type');
  ...
  await this.page.evaluate(() =>
    document
      .querySelector('[data-testid="confirm-homeworld-button"]')
      ?.scrollIntoView(),
  );
...
When("I choose a career path", async function () {
  ...
  const careerPromise = this.waitForAPIResponse(
    "characters/select-career",
    "POST",
  );
...
When("I choose a career path on mobile", async function () {
  ...
  await this.page.evaluate(() =>
    document
      .querySelector('[data-testid="career-option"]:first-of-type')
      ?.scrollIntoView(),
  );
  await this.clickElement('[data-testid="career-option"]:first-of-type');
  ...
  await this.page.evaluate(() =>
    document
      .querySelector('[data-testid="confirm-career-button"]')
      ?.scrollIntoView(),
  );
...
When("I complete career terms", async function () {
  ...
  while (termCount < maxTerms) {
    ...
    const continueButton = await this.page
      .locator('[data-testid="continue-career-button"]')
      .first();

    if (await continueButton.isVisible()) {
      const termPromise = this.waitForAPIResponse(
        "characters/complete-career-term",
        "POST",
      );
      ...
      const musterOutButton = await this.page.locator(
        '[data-testid="muster-out-button"]',
      );
...
When("I complete career terms on mobile", async function () {
  ...
  while (termCount < maxTerms) {
    ...
    if (await continueButton.isVisible()) {
      await this.page.evaluate(() =>
        document
          .querySelector('[data-testid="continue-career-button"]')
          ?.scrollIntoView(),
      );
      ...
      if ((await musterOutButton.isVisible()) && termCount >= 2) {
        await this.page.evaluate(() =>
          document
            .querySelector('[data-testid="muster-out-button"]')
            ?.scrollIntoView(),
        );
        await musterOutButton.click();
        break;
...
When("I select skills", async function () {
  ...
  const skillOptions = await this.page.locator(
...
When("I select skills on mobile", async function () {
  ...
  await this.page.evaluate(() =>
    document
      .querySelector('[data-testid="confirm-skills-button"]')
      ?.scrollIntoView(),
  );
...
When("I choose equipment", async function () {
  ...
  const equipmentOptions = await this.page.locator(
  ...
  if (equipmentCount > 0) {
    ...
    const equipmentPromise = this.waitForAPIResponse(
      "characters/add-equipment",
      "POST",
    );
...
When("I choose equipment on mobile", async function () {
  ...
  if (equipmentCount > 0) {
    ...
    await this.page.evaluate(() =>
      document
        .querySelector('[data-testid="confirm-equipment-button"]')
        ?.scrollIntoView(),
    );
...
When("I add a portrait on mobile", async function () {
  ...
  await this.page.evaluate(() =>
    document
      .querySelector('[data-testid="skip-portrait-button"]')
      ?.scrollIntoView(),
  );
  await this.clickElement('[data-testid="skip-portrait-button"]');
});
...
When("I review and confirm the character on mobile", async function () {
  ...
  await this.page.evaluate(() =>
    document
      .querySelector('[data-testid="create-character-button"]')
      ?.scrollIntoView(),
  );
...
Then(
  "my character should be created successfully on mobile",
  async function () {
    await this.waitForElement('[data-testid="character-creation-success"]');
...
Then("the character should be saved to the database", async function () {
  ...
  const response = await this.page.request.get(
    `${this.config.apiURL}/characters/${createdCharacter.id}`,
    {
      headers: {
...
Then("I should see the character in my character list", async function () {
  ...
  const characterElement = await this.waitForElement(
    `[data-testid="character-${createdCharacter.id}"]`,
  );
...
Then(
  "I should see the character in my character list on mobile",
  async function () {
    await this.navigateTo("/characters");
    await this.waitForElement('[data-testid="character-list"]');
