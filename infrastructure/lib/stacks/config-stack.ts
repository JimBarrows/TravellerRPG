...
export class ConfigStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: ConfigStackProps) {
    ...
    this.parameters.corsOrigins = new ssm.StringListParameter(
      this,
      "CorsOriginsParameter",
      {
    ...
    this.parameters.jwtExpiry = new ssm.StringParameter(
      this,
      "JwtExpiryParameter",
      {
    ...
    // Feature flags
    this.parameters.enableAdvancedCharGen = new ssm.StringParameter(
      this,
      "EnableAdvancedCharGenParameter",
      {
    ...
    this.parameters.enableVirtualTabletop = new ssm.StringParameter(
      this,
      "EnableVirtualTabletopParameter",
      {
    ...
    this.parameters.enableAiGameMaster = new ssm.StringParameter(
      this,
      "EnableAiGameMasterParameter",
      {
    ...
    this.parameters.maxConcurrentUsers = new ssm.StringParameter(
      this,
    ...
    this.parameters.lambdaTimeout = new ssm.StringParameter(
      this,
      "LambdaTimeoutParameter",
      {
    ...
    this.parameters.logLevel = new ssm.StringParameter(
      this,
      "LogLevelParameter",
      {
    ...
    this.parameters.enableDetailedMonitoring = new ssm.StringParameter(
      this,
      "EnableDetailedMonitoringParameter",
      {
    ...
    this.secrets.googleOAuthClient = new secretsmanager.Secret(
      this,
    ...
    this.secrets.facebookOAuthClient = new secretsmanager.Secret(
      this,
    ...
    this.secrets.appleOAuthClient = new secretsmanager.Secret(
      this,
      "AppleOAuthClientSecret",
      {
    ...
    this.secrets.stripeApiKey = new secretsmanager.Secret(
      this,
      "StripeApiKeySecret",
      {
    ...
    this.parameters.emailFromAddress = new ssm.StringParameter(
      this,
    ...
    this.secrets.sendGridApiKey = new secretsmanager.Secret(
      this,
    ...
    const lambdaEnvVars = {
      ...
      ENABLE_ADVANCED_CHAR_GEN:
        this.parameters.enableAdvancedCharGen.parameterName,
      ENABLE_VIRTUAL_TABLETOP:
        this.parameters.enableVirtualTabletop.parameterName,
      ENABLE_AI_GAME_MASTER: this.parameters.enableAiGameMaster.parameterName,
      ENABLE_DETAILED_MONITORING:
        this.parameters.enableDetailedMonitoring.parameterName,
    };
