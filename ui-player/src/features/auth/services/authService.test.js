...
import authService, { authService as namedAuthService, cognitoAuth as exportedCognitoAuth } from './authService.js';
...
describe('AuthService', () => {
  ...
  describe('configure', () => {
    it('should log configuration without user pool credentials', async () => {
      ...
      expect(console.log).toHaveBeenCalledWith('Auth service configured with:', { 
        hasUserPoolId: false,
        hasClientId: false 
      });
    });
  ...
  describe('signIn', () => {
    it('should sign in successfully and return formatted result', async () => {
      ...
      expect(mockCognitoAuth.signIn).toHaveBeenCalledWith('testuser', 'password123', false);
    ...
    it('should handle sign in with rememberMe option', async () => {
      ...
      expect(mockCognitoAuth.signIn).toHaveBeenCalledWith('testuser', 'password123', true);
    });
    ...
    it('should handle sign in errors gracefully', async () => {
      ...
      await expect(authService.signIn('testuser', 'password123'))
        .rejects.toThrow('Network error');
      
      expect(console.error).toHaveBeenCalledWith('AuthService signIn error:', error);
    });
    ...
    it('should handle cognitoAuth throwing error with custom message', async () => {
      ...
      await expect(authService.signIn('testuser', 'badpass'))
    ...
    it('should handle error without message', async () => {
      ...
      await expect(authService.signIn('testuser', 'password'))
        .rejects.toThrow('Sign in failed');
    });
  });
  ...
  describe('signUp', () => {
    it('should sign up successfully', async () => {
      ...
      const result = await authService.signUp('testuser', 'password123', 'test@example.com', { name: 'Test User' });

      expect(mockCognitoAuth.signUp).toHaveBeenCalledWith('testuser', 'password123', 'test@example.com', { name: 'Test User' });
      expect(result).toEqual({
    ...
    it('should handle confirmed user sign up', async () => {
      ...
      const result = await authService.signUp('confirmeduser', 'password123', 'confirmed@example.com');
    ...
    it('should handle sign up with minimal attributes', async () => {
      ...
      const result = await authService.signUp('minimaluser', 'password123', 'minimal@example.com');

      expect(mockCognitoAuth.signUp).toHaveBeenCalledWith('minimaluser', 'password123', 'minimal@example.com', {});
    });
    ...
    it('should handle sign up errors', async () => {
      ...
      await expect(authService.signUp('testuser', 'password123', 'existing@example.com'))
        .rejects.toThrow('Email already exists');
      
      expect(console.error).toHaveBeenCalledWith('AuthService signUp error:', error);
    });

    it('should handle sign up error without message', async () => {
      mockCognitoAuth.signUp.mockRejectedValue(new Error());

      await expect(authService.signUp('testuser', 'password123', 'test@example.com'))
  ...
  describe('confirmSignUp', () => {
    it('should confirm sign up successfully', async () => {
      ...
      expect(mockCognitoAuth.confirmSignUp).toHaveBeenCalledWith('testuser', '123456');
      expect(result).toEqual({
        isSignUpComplete: true,
    ...
    it('should handle confirmation errors', async () => {
      ...
      await expect(authService.confirmSignUp('testuser', 'wrongcode'))
        .rejects.toThrow('Invalid code');
      
      expect(console.error).toHaveBeenCalledWith('AuthService confirmSignUp error:', error);
    });

    it('should handle confirmation error without message', async () => {
      mockCognitoAuth.confirmSignUp.mockRejectedValue(new Error());

      await expect(authService.confirmSignUp('testuser', '123456'))
  ...
  describe('signOut', () => {
    ...
    it('should handle sign out errors', async () => {
      ...
      expect(console.error).toHaveBeenCalledWith('AuthService signOut error:', error);
    });
  ...
  describe('getCurrentUser', () => {
    ...
    it('should handle errors gracefully and return null', async () => {
      ...
      expect(result).toBeNull();
      expect(console.error).toHaveBeenCalledWith('AuthService getCurrentUser error:', error);
    });
  ...
  describe('fetchAuthSession', () => {
    ...
    it('should handle errors gracefully', async () => {
      ...
      expect(console.error).toHaveBeenCalledWith('AuthService fetchAuthSession error:', error);
    });
  });
  ...
  describe('updateUserAttributes', () => {
    it('should log warning and return not updated', async () => {
      ...
      expect(console.warn).toHaveBeenCalledWith('updateUserAttributes not yet implemented with direct Cognito SDK');
    });
    ...
    it('should handle errors in updateUserAttributes', async () => {
      ...
      await expect(authService.updateUserAttributes({}))
  ...
  describe('updatePassword', () => {
    it('should log warning and return not updated', async () => {
      ...
      expect(console.warn).toHaveBeenCalledWith('updatePassword not yet implemented with direct Cognito SDK');
    });
  ...
  describe('resetPassword', () => {
    ...
    it('should handle reset password errors', async () => {
      ...
      await expect(authService.resetPassword('nonexistent'))
        .rejects.toThrow('User not found');
      
      expect(console.error).toHaveBeenCalledWith('AuthService resetPassword error:', error);
    });

    it('should handle reset password error without message', async () => {
      mockCognitoAuth.forgotPassword.mockRejectedValue(new Error());

      await expect(authService.resetPassword('testuser'))
  ...
  describe('confirmResetPassword', () => {
    it('should confirm password reset successfully', async () => {
      ...
      const result = await authService.confirmResetPassword('testuser', 'newpass123', '123456');

      expect(mockCognitoAuth.confirmForgotPassword).toHaveBeenCalledWith('testuser', '123456', 'newpass123');
      expect(result).toEqual({
    ...
    it('should handle confirm reset password errors', async () => {
      ...
      await expect(authService.confirmResetPassword('testuser', 'newpass', 'wrongcode'))
        .rejects.toThrow('Invalid reset code');
      
      expect(console.error).toHaveBeenCalledWith('AuthService confirmResetPassword error:', error);
    });
    ...
    it('should handle confirm reset password error without message', async () => {
      ...
      await expect(authService.confirmResetPassword('testuser', 'newpass', '123456'))
  ...
  describe('edge cases and error handling', () => {
    ...
    it('should handle methods with undefined parameters', async () => {
      ...
      await expect(authService.signIn(undefined, undefined))
        .rejects.toThrow('Sign in failed');
    });
