...
describe('CognitoAuthService', () => {
  ...
  describe('signUp', () => {
    it('should sign up user successfully', async () => {
      ...
      mockUserPool.signUp.mockImplementation((username, password, attributeList, nullValue, callback) => {
        callback(null, mockResult);
      });

      const result = await service.signUp('testuser', 'password123', 'test@example.com');
    ...
    it('should handle sign up with additional attributes', async () => {
      ...
      await service.signUp('testuser', 'password123', 'test@example.com', additionalAttributes);
    ...
    it('should handle sign up errors', async () => {
      ...
      await expect(service.signUp('existing', 'password123', 'existing@example.com'))
    ...
    it('should handle sign up errors without message', async () => {
      ...
      await expect(service.signUp('testuser', 'password123', 'test@example.com'))
  ...
  describe('confirmSignUp', () => {
    ...
    it('should handle confirmation errors', async () => {
      ...
      await expect(service.confirmSignUp('testuser', 'wrongcode'))
    ...
    it('should handle confirmation errors without message', async () => {
      ...
      await expect(service.confirmSignUp('testuser', '123456'))
  ...
  describe('getCurrentUser', () => {
    ...
    it('should handle user attributes errors', async () => {
      ...
      await expect(service.getCurrentUser())
        .rejects.toThrow('Failed to get attributes');
    });
  });
  ...
  describe('forgotPassword', () => {
    ...
    it('should handle forgot password errors', async () => {
      ...
      await expect(service.forgotPassword('nonexistent'))
    ...
    it('should handle forgot password errors without message', async () => {
      ...
      await expect(service.forgotPassword('testuser'))
  ...
  describe('confirmForgotPassword', () => {
    it('should confirm password reset successfully', async () => {
      ...
      const result = await service.confirmForgotPassword('testuser', '123456', 'newpassword123');

      expect(result).toBe(mockResult);
      expect(mockCognitoUser.confirmPassword).toHaveBeenCalledWith('123456', 'newpassword123', expect.any(Object));
    });
    ...
    it('should handle confirm password errors', async () => {
      ...
      await expect(service.confirmForgotPassword('testuser', 'wrongcode', 'newpassword'))
        .rejects.toThrow('Invalid code');
    });
    ...
    it('should handle confirm password errors without message', async () => {
      ...
      await expect(service.confirmForgotPassword('testuser', '123456', 'newpassword'))
  ...
  describe('error handling and edge cases', () => {
    ...
    it('should handle user attributes errors without message', async () => {
      ...
      await expect(service.getCurrentUser())
        .rejects.toThrow('Failed to get user attributes');
    });
  });
});