...
import {
  ...
  isTokenValid,
  shouldRefreshToken,
} from "../../features/auth/utils/tokenUtils.simple.js";

// Test tokens
const validToken =
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyLCJleHAiOjk5OTk5OTk5OTl9.8lXzjwb_lfJn3ZlHpxwpew4WXMpjCA6-TAlKxLILOdg";
const expiredToken =
...
Given("I have a token that is about to expire", function () {
  ...
  const soonToExpireToken = `eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.${btoa(
    JSON.stringify({
      sub: "1234567890",
      exp: futureTime,
    }),
