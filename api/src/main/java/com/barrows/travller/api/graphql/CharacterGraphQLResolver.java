 ...
 */
@Controller
public class CharacterGraphQLResolver {
    ...
    public CharacterGraphQLResolver(CharacterRepository characterRepository,
     ...
     */
    @QueryMapping
    public com.barrows.travller.api.model.Character character(@Argument Long id) {
     ...
     */
    @MutationMapping
    public com.barrows.travller.api.model.Character createCharacter(@Argument CharacterInput input) {
        Race race = raceRepository.findById(input.getRaceId())
                .orElseThrow(() -> new IllegalArgumentException("Race not found"));

        com.barrows.travller.api.model.Character character = new com.barrows.travller.api.model.Character(input.getName());
     ...
     */
    @MutationMapping
    public com.barrows.travller.api.model.Character updateCharacter(@Argument Long id, @Argument CharacterInput input) {
        com.barrows.travller.api.model.Character character = characterRepository.findById(id)
     ...
     */
    @MutationMapping
    public com.barrows.travller.api.model.Character generateCharacteristics(@Argument Long characterId) {
        com.barrows.travller.api.model.Character character = characterRepository.findById(characterId)
                .orElseThrow(() -> new IllegalArgumentException("Character not found"));
        ...
        if (character.getCharacteristics() != null) {
            ...
            character.setCharacteristics(new ArrayList<>());
        }
     ...
     */
    @MutationMapping
    public com.barrows.travller.api.model.Character selectHomeworld(@Argument Long characterId, @Argument Long homeworldId) {
        com.barrows.travller.api.model.Character character = characterRepository.findById(characterId)
                .orElseThrow(() -> new IllegalArgumentException("Character not found"));
        ...
        if (homeworld.getCommonSkills() != null) {
     ...
     */
    @MutationMapping
    public com.barrows.travller.api.model.Character selectCareer(@Argument Long characterId, @Argument Long careerId) {
        com.barrows.travller.api.model.Character character = characterRepository.findById(characterId)
                .orElseThrow(() -> new IllegalArgumentException("Character not found"));
    ...
    public CareerQualificationResult attemptCareerQualification(@Argument Long characterId) {
        ...
        Optional<Career> careerOpt = careerRepository.findByNameIgnoreCase(careerName);
        if (careerOpt.isEmpty()) {
            throw new IllegalArgumentException("Career not found: " + careerName);
        }
        Career career = careerOpt.get();

        // Get the qualification requirements
        Map<CharacteristicType, Integer> qualificationRequirements = career.getQualificationRequirements();
        if (qualificationRequirements.isEmpty()) {
            throw new IllegalStateException("Career has no qualification requirements");
        }

        // Get the primary qualification characteristic (first one in the map)
        Map.Entry<CharacteristicType, Integer> primaryRequirement = qualificationRequirements.entrySet().iterator().next();
        CharacteristicType qualificationCharacteristic = primaryRequirement.getKey();
        int qualificationDifficulty = primaryRequirement.getValue();
        ...
        if (!qualified) {
            ...
            if (drafted) {
                ...
                Optional<Career> militaryCareerOpt = careerRepository.findByNameIgnoreCase("Marines");
                Career militaryCareer = null;

                if (militaryCareerOpt.isPresent()) {
                    militaryCareer = militaryCareerOpt.get();
    ...
    public CareerTermResult completeCareerTerm(@Argument Long characterId) {
        ...
        List<Skill> gainedSkills = new ArrayList<>();
        List<String> benefits = new ArrayList<>();
        List<String> events = new ArrayList<>();
        events.add("Standard term of service.");

        if (survived) {
            // Gain skills (simplified for this example)
            // In a real implementation, you would use the career's skill tables
            if (career.getServiceSkillTables() != null && !career.getServiceSkillTables().isEmpty()) {
                gainedSkills = career.getServiceSkillTables().stream()
                        .map(com.barrows.travller.api.model.SkillTable::getSkill)
                        .limit(2) // Gain 2 skills per term
                        .collect(Collectors.toList());

                for (Skill skill : gainedSkills) {
                    character.addSkill(skill);
                    careerTerm.addSkill(skill);
                }
            }
            ...
            careerTerm.getBenefits().add(benefit);
     ...
     */
    @MutationMapping
    public com.barrows.travller.api.model.Character musterOut(@Argument Long characterId) {
        com.barrows.travller.api.model.Character character = characterRepository.findById(characterId)
                .orElseThrow(() -> new IllegalArgumentException("Character not found"));

        // Check if the character has completed at least one term
        if (character.getCareerHistory() == null || character.getCareerHistory().isEmpty()) {
     ...
     */
    @MutationMapping
    public com.barrows.travller.api.model.Character addWeaponToCharacter(@Argument Long characterId, @Argument Long weaponId) {
        com.barrows.travller.api.model.Character character = characterRepository.findById(characterId)
                .orElseThrow(() -> new IllegalArgumentException("Character not found"));
     ...
     */
    @MutationMapping
    public com.barrows.travller.api.model.Character addArmorToCharacter(@Argument Long characterId, @Argument Long armorId) {
        com.barrows.travller.api.model.Character character = characterRepository.findById(characterId)
                .orElseThrow(() -> new IllegalArgumentException("Character not found"));
     ...
     */
    @MutationMapping
    public com.barrows.travller.api.model.Character equipWeapon(@Argument Long characterId, @Argument Long weaponId) {
        com.barrows.travller.api.model.Character character = characterRepository.findById(characterId)
                .orElseThrow(() -> new IllegalArgumentException("Character not found"));
     ...
     */
    @MutationMapping
    public com.barrows.travller.api.model.Character equipArmor(@Argument Long characterId, @Argument Long armorId) {
        com.barrows.travller.api.model.Character character = characterRepository.findById(characterId)
                .orElseThrow(() -> new IllegalArgumentException("Character not found"));
    ...
    public static class CareerQualificationResult {
        private com.barrows.travller.api.model.Character character;
        private boolean qualified;
        private boolean drafted;
        private Career career;

        public com.barrows.travller.api.model.Character getCharacter() {
            return character;
        }

        public void setCharacter(com.barrows.travller.api.model.Character character) {
